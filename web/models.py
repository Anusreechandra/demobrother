...
class Product(models.Model):
    ...
    product_catagary = models.CharField(max_length=100,null=True)
...
class Verticals(models.Model):
    vimage = VersatileImageField('Image',upload_to = 'image/testimagemodel/')
    
    vname = models.CharField(max_length=20,null=True)
    vdis = models.CharField(max_length=100,null=True)
...
class Modal(models.Model):
        modalimage         = VersatileImageField('Image',upload_to = 'image/testimagemodel/',default=True)
        modaldis = models.CharField(max_length=50,default=True)

        class Meta:
            db_table = 'modal'
        def __str__(self):
            return str(self.modalimage) 
